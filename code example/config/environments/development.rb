Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    ...
    domain: Rails.application.credentials.smtp.dig(:domain),
    port: Rails.application.credentials.smtp.dig(:port),
    authentication: Rails.application.credentials.smtp.dig(:authentication)
  }
