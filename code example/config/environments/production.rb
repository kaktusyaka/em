Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "TheSMMTools_production"
  ...
  if ENV['RAILS_LOG_TO_STDOUT'].present?
    if Rails.application.credentials.dig(:logentries_key)
      logger = Le.new(Rails.application.credentials.dig(:logentries_key))
    else
  ...
  config.action_controller.default_url_options = { host: Figaro.env.domain }
